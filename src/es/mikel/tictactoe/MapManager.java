...
public class MapManager {
	...
	public MapManager() {
		positions = new Vector2[]{new Vector2(0, 0, " "), new Vector2(1, 0, " "), new Vector2(2, 0, " "), new Vector2(0, 1 , " "), new Vector2(1, 1, " "), new Vector2(2, 1, " "), new Vector2(0, 2, " "), new Vector2(1, 2, " "), new Vector2(2, 2, " ")};
	}
	...
	public boolean canChangePositionValue(Vector2 position) {
		return (Arrays.asList(positions).contains(position) && Arrays.asList(positions).get(Arrays.asList(positions).indexOf(position)).getValue() == " ")  ? true : false;
	}
